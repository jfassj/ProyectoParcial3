      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="AdminQuejas.php">Quejas</a>
            <a class="collapse-item" href="AdminUsers.php">Usuarios</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Quejas pendientes</h1>

          <table id="tblCategorias" class="table table-hover table-bordered">
            <thead>
                <tr>
